<ul class="navbar-nav bg-gray-900 sidebar sidebar-dark accordion" id="accordionSidebar">
  ...
  <li class="nav-item">
    <a class="nav-link" href="index.php">
      <i class="fa fa-fw fa-tachometer-alt text-warning"></i>
  ...
  <div id="content">
      <nav class="navbar navbar-expand navbar-light bg-success topbar mb-4 static-top shadow">
		...
		<div class="d-sm-flex bg-dark pict" >	
			...
			<h6 class="text-white d-none d-md-block mt-4 mx-4 pl-3" >Siswa</h6>
...
<li class="nav-item dropdown no-arrow">
  ...
  <h6 class="collapse-header text-success ml-3 my-3 text-left"><b>Welcome <?= $name; ?></b><br><div class="d-block d-sm-none text-gray-400 pt-1">(Siswa)</div></h6>
